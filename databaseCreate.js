...
db.page.insert({index: 0, title: 'Objective', name: 'objective.html', path: '/client/views/', description: '<p>This project has been made to show how the author would code a MEAN application from scratch. Main goal is demonstrate some of this stack capabilities, going through angularJS directives, controllers, services, nodeJS modules, mongoDB access and so forth.</p><p>Another thing in mind when it was build, was that should be able to show its own source code by asking the server to read its own system folders and files.</p><p>Every page, including this one, have a "<b>(source code)</b>" link that will show how current page was built.</p>'})
db.page.insert({index: 1, title: 'Architecture', name: 'architecture.html', path: '/client/views/', description: '<p>Here you can see how this project is organized, from client to server and every file that put this together.</p><p>There is a folder \'node_modules\', that you <b>can not</b> see here. This folder have a very extensive hierarchy containing nodeJS modules used in this project. You can access my <b>github</b> to get a full view of it.</p>'})
